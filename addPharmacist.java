...
//            2- create statment
            ...
            myRs=stmt.executeQuery("Select pharmacyName from pharmacy");
               while(myRs.next()){
//                   System.out.println(myRs.getString("ID")+","+myRs.getString("Username"));
                        System.out.println("In pharamacname"+myRs.getString("pharmacyName"));
                   pharmacyname.addItem(myRs.getString("pharmacyName"));
               }
               myConn.close();
...
//            2- create statment
            ...
            //3- Execute Query for drop down itmes
               myRs=null;
               pharmacyName=pharmacyname.getSelectedItem().toString();
                myStmt=myConn.prepareStatement("Select pharmacyID from pharmacy  where pharmacyName = ?");
                myStmt.setString(1,pharmacyName);
                myRs=myStmt.executeQuery();
                
               while(myRs.next()){
//                   System.out.println(myRs.getString("ID")+","+myRs.getString("Username"));
                    pharmacyID=Integer.parseInt(myRs.getString("pharmacyID"));
                    System.out.println(pharmacyID);
               }
            //2- create statment
           myStmt=myConn.prepareStatement("Insert into pharmacist (username,password,PharmacistName,age,gender,address,phone,cnic,email,pharmacyID) values (?,?,?,?,?,?,?,?,?,?)");

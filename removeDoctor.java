...
public class removeDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor Name", "Doctor Name", "Specializtion"
            }
        ) {
...
//            2- create statment
            ...
            //3- Execute Query 
                myStmt=myConn.prepareStatement("Select doctorID,DoctorName,specialization from doctor");
               ...
               while(myRs.next()){
                   //------ Add row in table and data of corrosponding column-------//
                    Df.addRow(new Object[]{myRs.getString("doctorID"),myRs.getString("DoctorName"),myRs.getString("specialization")});
               }  
        }
          catch(Exception ex){

...
public class removeDepartment extends javax.swing.JFrame {
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        ...
        String sql="Delete from  department where  departmentID = "+cell;
        try{
...
//            2- create statment
            ...
            //3- Execute Query 
               ...
               while(myRs.next()){
                   //------ Add row in table and data of corrosponding column-------//
                    Df.addRow(new Object[]{myRs.getString("departmentID"),myRs.getString("departmentName")});
               }  
        }
          catch(Exception ex){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(removeDepartment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

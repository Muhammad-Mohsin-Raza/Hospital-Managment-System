...
//                   System.out.println(myRs.getString("ID")+","+myRs.getString("Username"));
            ...
            //2- create statment
           myStmt=myConn.prepareStatement("Insert into nurse (username,password,NurseName,age,gender,address,phone,cnic,email,departmentID) values (?,?,?,?,?,?,?,?,?,?)");

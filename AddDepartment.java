...
public class AddDepartment extends javax.swing.JFrame {
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        String deptName=inputName.getText();
        ...
        try{
            ...
            //2- create statment
           myStmt=myConn.prepareStatement("Insert into department (departmentName) values (?)");
            myStmt.setString(1,deptName);
            myStmt.executeUpdate();
            JOptionPane.showMessageDialog(AddDepartment.this,"Added successfully...");
            inputName.setText("");
        }
        catch(Exception ex ){
            JOptionPane.showMessageDialog(AddDepartment.this,ex);
        }

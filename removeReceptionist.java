...
public class removeReceptionist extends javax.swing.JFrame {
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        ...
        String sql="Delete from  receptionist where  receptionistID = "+cell;
        try{
...
//            2- create statment
            ...
            //3- Execute Query 
                myStmt=myConn.prepareStatement("select  receptionistID, ReceptionistName from  receptionist");
               ...
               while(myRs.next()){
                   //------ Add row in table and data of corrosponding column-------//
                    Df.addRow(new Object[]{myRs.getString("receptionistID"),myRs.getString("ReceptionistName")});
               }  
        }
          catch(Exception ex){
